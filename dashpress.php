...
"><input type="image" src="https://www.paypal.com/en_US/i/btn/btn_donate_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!"><img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1"></form>';
	...
	// for javascript
		...
		wp_register_script ( self::screen,		'/' . DBP_PLUGIN_DIR . 'dbp-admin/js/dbp.js');
...
?>
<div id='dashboard-options-wrap' class='hidden' tabindex='-1' aria-label='<?php esc_attr_e('Dashboard Options', self::txt_domain); ?>'>
...
<div id='dashboard-options-link-wrap' class='hide-if-no-js screen-meta-toggle'>
	<button type='button' id='dashboard-options-link' class='button show-settings' aria-controls='dashboard-options-wrap' aria-expanded='false'>
